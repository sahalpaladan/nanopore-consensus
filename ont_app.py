...
if run_btn:
    if reference and reads and bed:
        ...
        commands = [
            ...
            f"minimap2 -ax map-ont -t {threads} {ref_path} {reads_path} | samtools sort -@ {threads} -o {workdir}/sorted.bam",
            ...
            f"bcftools consensus -f {ref_path} {workdir}/variants.vcf.gz > {workdir}/consensus.fasta"
        ]
